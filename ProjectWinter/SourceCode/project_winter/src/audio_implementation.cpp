...
// 1. Include ONLY the header definitions of stb_vorbis
#define STB_VORBIS_HEADER_ONLY
#include "stb_vorbis.c" 

// 2. Define the miniaudio implementation
// This now "sees" the stb_vorbis types and enables ma_stbvorbis
#define MINIAUDIO_IMPLEMENTATION
#include "miniaudio.h"

// 3. Include the actual code logic for stb_vorbis
#undef STB_VORBIS_HEADER_ONLY
#include "stb_vorbis.c"

// Correct VTable implementation for stb_vorbis
static ma_result ma_decoding_backend_init_stb_vorbis(void* pUserData, ma_read_proc onRead, ma_seek_proc onSeek, ma_tell_proc onTell, void* pReadSeekTellUserData, const ma_decoding_backend_config* pConfig, const ma_allocation_callbacks* pAllocationCallbacks, ma_data_source** ppBackend)
{
